...
class All_Products_Block2 extends StatefulWidget {
  @override
  _All_Products_Block2State createState() => _All_Products_Block2State();
}

class _All_Products_Block2State extends State<All_Products_Block2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Atta",style: TextStyle(fontWeight:FontWeight.bold,fontSize: 30),),
